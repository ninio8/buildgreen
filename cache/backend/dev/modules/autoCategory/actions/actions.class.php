...
abstract class autoCategoryActions extends sfActions
{
  ...
  public function executeFilter(sfWebRequest $request)
  {
    ...
    if ($request->hasParameter('_reset'))
    {
      ...
      $this->redirect('@buildgreen_category');
    }
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->buildgreen_category = $this->form->getObject();
  }
  ...
  {
    $this->buildgreen_category = $this->getRoute()->getObject();
    $this->form = $this->configuration->getForm($this->buildgreen_category);
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'BuildgreenCategory'));
    try
    {
      // validate ids
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      $this->dispatcher->notify(new sfEvent($this, 'admin.save_object', array('object' => $buildgreen_category)));

      if ($request->hasParameter('_save_and_add'))
      {
        $this->getUser()->setFlash('notice', $notice.' You can add another one below.');

        $this->redirect('@buildgreen_category_new');
      }
      else
      {
        $this->getUser()->setFlash('notice', $notice);

        $this->redirect(array('sf_route' => 'buildgreen_category_edit', 'sf_subject' => $buildgreen_category));
      }
    }
    else
    {
  ...
  {
    $pager = $this->configuration->getPager('BuildgreenCategory');
  ...
  {
    return Doctrine_Core::getTable('BuildgreenCategory')->hasColumn($column);
  }
}
